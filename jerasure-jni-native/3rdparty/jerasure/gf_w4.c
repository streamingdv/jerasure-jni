...
static
void
gf_w4_single_table_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                   int xor) {
    int i;
    uint8_t b, c;
    uint8_t *s8, *d8;
...
static
void
gf_w4_double_table_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                   int xor) {
    int i;
    uint8_t *s8, *d8, *base;
    gf_region_data rd;
...
static
void
gf_w4_quad_table_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                 int xor) {
    uint16_t *base;
    gf_region_data rd;
    struct gf_quad_table_data *std;
...
static
void
gf_w4_bytwo_p_nosse_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                    int xor) {
...
static
void
gf_w4_bytwo_b_nosse_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                    int xor) {
