...
static
void
gf_w16_multiply_region_from_single(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                   int xor) {
    gf_region_data rd;
    uint16_t *s16;
    uint16_t *d16;
...
static
void
gf_w16_split_4_16_lazy_nosse_altmap_multiply_region(gf_t *gf, void *src, void *dest,
...
static
void
gf_w16_split_4_16_lazy_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                       int xor) {
...
static
void
gf_w16_split_8_16_lazy_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                       int xor) {
...
static void
gf_w16_table_lazy_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                  int xor) {
    uint64_t c;
    gf_internal_t *h;
...
int gf_w16_split_init(gf_t *gf) {
    ...
    if ((h->arg1 == 8 && h->arg2 == 16) || (h->arg2 == 8 && h->arg1 == 16)) {
        ...
        if (h->region_type & GF_REGION_SIMD)
            ...
            SET_FUNCTION(gf, multiply_region, w32,
                         gf_w16_split_4_16_lazy_nosse_altmap_multiply_region)
        else
            SET_FUNCTION(gf, multiply_region, w32, gf_w16_split_4_16_lazy_multiply_region)
#if defined(INTEL_SSSE3) || defined(ARM_NEON)
        }
...
static
void
gf_w16_log_zero_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                int xor) {
    uint16_t lv;
    int i;
...
static
void
gf_w16_bytwo_p_nosse_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                     int xor) {
...
static
void
gf_w16_bytwo_b_nosse_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                     int xor) {
...
gf_w16_composite_multiply_recursive(gf_t *gf, gf_val_32_t a, gf_val_32_t b) {
    ...
    rv = ((base_gf->multiply.w32(base_gf, a0, b0) ^ a1b1) |
          ((base_gf->multiply.w32(base_gf, a1, b0) ^ base_gf->multiply.w32(base_gf, a0, b1) ^
...
gf_w16_composite_multiply_inline(gf_t *gf, gf_val_32_t a, gf_val_32_t b) {
    ...
    rv = ((GF_W8_INLINE_MULTDIV(mt, a0, b0) ^ a1b1) |
          ((GF_W8_INLINE_MULTDIV(mt, a1, b0) ^ GF_W8_INLINE_MULTDIV(mt, a0, b1) ^
...
gf_w16_composite_inverse(gf_t *gf, gf_val_32_t a) {
    ...
    if (a0 == 0) {
        ...
        tmp = (base_gf->multiply.w32(base_gf, a1, a0inv) ^
               base_gf->multiply.w32(base_gf, a0, a1inv) ^ h->prim_poly);
...
static
void
gf_w16_composite_multiply_region(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                 int xor) {
    gf_internal_t *h = (gf_internal_t *) gf->scratch;
    gf_t *base_gf = h->base_gf;
...
static
void
gf_w16_composite_multiply_region_alt(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                     int xor) {
    gf_internal_t *h = (gf_internal_t *) gf->scratch;
    gf_t *base_gf = h->base_gf;
    ...
    base_gf->multiply_region.w32(base_gf, shigh, dhigh,
                                 base_gf->multiply.w32(base_gf, h->prim_poly, val1), sub_reg_size,
                                 1);
...
static
void gf_w16_group_4_4_region_multiply(gf_t *gf, void *src, void *dest, gf_val_32_t val, int bytes,
                                      int xor) {
